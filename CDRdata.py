...
def load_data():
  ...
  #dropna() is to drop unnecessary values
...
def create_app_ui():
    ...
    [
     ...
     #create 3 tabs with dropdowns
     dcc.Tabs(id = 'Tabs', value = 'Call Analytics tool', children = [     
     dcc.Tab(id = 'Call Analytics tool', label = 'Call Analytics tool', value = 'Call Analytics tool' ,children  = [ 
     #tab for call analytics
     ...
     dcc.Tab( id = 'Service Analytics tool', label = 'Service Analytics tool', value = 'Service Analytics tool', children = [ 
     # tab for service analytics
     ...
     dcc.Tab(label = "Device Analytics tool", id="Device Analytics tool", value='Device Analytics tool', children = [            
     # tab for device analytics   
     ...
     # for the graph , card and table in call analytics
     ])
...
def update_app_ui(Tabs,start_date, end_date, group, report_type, device_date,service_date):
   ...
   # if u select call analytics tab     
   if Tabs == "Call Analytics tool": 
   ...
   # if u select service analytics tab
   elif Tabs == 'Service Analytics tool':
   ...
   # if u select device analytics tab 
   elif Tabs == 'Device Analytics tool':
